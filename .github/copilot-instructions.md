...
This project is an azure static web application for a personal website 
It contains a main public page under /src, and an admin page under /src/admin that require an authenticated role to access.
